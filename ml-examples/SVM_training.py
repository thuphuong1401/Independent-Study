...
train_prob_pred = clf.predict_proba(train_xs)
print("Shape {}".format(train_prob_pred.shape))
val_prob_pred = clf.predict_log_proba(val_xs)
test_prob_pred = clf.predict_log_proba(test_xs)
...
plt.savefig("SVM-confusion-matrices.png", bboxes="tight")

make_directory("results/SVM/")

# save model here
from joblib import dump, load
dump(clf, "results/SVM/SVM.joblib")
